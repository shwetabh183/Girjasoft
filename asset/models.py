...
class AssetCategory(GirjasoftModel):
    """
...
class Asset(GirjasoftModel):
    ...
    objects = GirjasoftCompanyManager("asset_category_id__company_id")
...
class AssetReport(GirjasoftModel):
    """
...
class AssetDocuments(GirjasoftModel):
    """
...
class ReturnImages(GirjasoftModel):
    """
...
class AssetAssignment(GirjasoftModel):
    """
    ...
    objects = GirjasoftCompanyManager("asset_id__asset_lot_number_id__company_id")
...
class AssetRequest(GirjasoftModel):
    """
