...
from girjasoft.girjasoft_apps import TWO_FACTORS_AUTHENTICATION
from girjasoft.girjasoft_settings import APPS
from girjasoft.methods import get_girjasoft_model_class
from girjasoft_documents.models import DocumentRequest

CACHE_KEY = "girjasoft_company_models_cache_key"
...
class CompanyMiddleware:
    ...
    def _add_company_filter(self, model, company_id):
        ...
        is_girjasoft_manager = isinstance(model.objects, GirjasoftCompanyManager)
        ...
        if is_company_model:
            ...
            elif is_girjasoft_manager and related_company_field:
                model.add_to_class(
            ...
            for app_label, models in app_model_mappings.items():
                if apps.is_installed(app_label):
                    company_models.extend(
                        [get_girjasoft_model_class(app_label, model) for model in models]
                    )
