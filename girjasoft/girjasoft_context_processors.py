"""
girjasoft_context_process.py

This module is used to register context processors without effecting the girjasoft/settings.py module
"""

from girjasoft.settings import TEMPLATES

TEMPLATES[0]["OPTIONS"]["context_processors"].append(
    "girjasoft.config.get_MENUS",
)
TEMPLATES[0]["OPTIONS"]["context_processors"].append(
