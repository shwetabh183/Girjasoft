"""
girjasoft_middlewares.py

This module is used to register girjasoft's middlewares without affecting the girjasoft/settings.py
"""
...
MIDDLEWARE.append("girjasoft.girjasoft_middlewares.MethodNotAllowedMiddleware")
MIDDLEWARE.append("girjasoft.girjasoft_middlewares.ThreadLocalMiddleware")
MIDDLEWARE.append("girjasoft.girjasoft_middlewares.SVGSecurityMiddleware")
