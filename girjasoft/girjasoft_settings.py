...
from girjasoft.girjasoft_apps import INSTALLED_APPS
...
DEFAULT_LDAP_CONFIG = {
    ...
    "BIND_DN": settings.env("BIND_DN", default="cn=admin,dc=girjasoft,dc=com"),
    "BIND_PASSWORD": settings.env("BIND_PASSWORD", default="girjasoft"),
    "BASE_DN": settings.env("BASE_DN", default="ou=users,dc=girjasoft,dc=com"),
}
...
def load_ldap_settings():
    ...
    try:
        ...
        from girjasoft_ldap.models import LDAPSettings
