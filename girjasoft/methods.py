...
from girjasoft.girjasoft_settings import APP_URLS, DYNAMIC_URL_PATTERNS


def get_girjasoft_model_class(app_label, model):
    """
...
def girjasoft_users_with_perms(permissions):
    """
