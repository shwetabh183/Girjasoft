...
This module defines the abstract base model `GirjasoftModel` for the Girjasoft HRMS project.
The `GirjasoftModel` provides common fields and functionalities for other models within
...
class GirjasoftModel(models.Model):
    """
    An abstract base model that includes common fields and functionalities
    for models within the Girjasoft application.
    """
    ...
    girjasoft_history = AuditlogHistoryField()
    ...
    def save(self, *args, **kwargs):
        ...
        super(GirjasoftModel, self).save(*args, **kwargs)
...
auditlog.register(GirjasoftModel, serialize_data=True)
