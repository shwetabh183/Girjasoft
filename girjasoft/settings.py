"""
Django settings for girjasoft project.
...
WSGI_APPLICATION = "girjasoft.wsgi.application"
...
LOCALE_PATHS = [
    join(BASE_DIR, "girjasoft", "locale"),
]
