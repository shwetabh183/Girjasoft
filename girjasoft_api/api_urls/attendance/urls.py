"""
girjasoft_api/urls/attendance/urls.py
"""

from django.urls import path

from girjasoft_api.api_views.attendance.permission_views import AttendancePermissionCheck
from girjasoft_api.api_views.attendance.views import *
