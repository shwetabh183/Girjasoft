...
from girjasoft.decorators import apply_decorators
...
class Bot:
    ...
    def __str__(self) -> str:
        return "Girjasoft Bot"

    def get_avatar(self):
        return "https://ui-avatars.com/api/?name=Girjasoft+Bot&background=random"
...
def history_tracking(request, obj_id, **kwargs):
    ...
    def _history_tracking(request, obj_id, model):
        ...
        histories = instance.girjasoft_history.all()
        ...
        return render(
            request,
            "girjasoft_audit/history_tracking.html",
            context,
        )
