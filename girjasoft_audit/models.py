...
from girjasoft_audit.methods import remove_duplicate_history
...
class AuditTag(models.Model):
    ...
    class Meta:
        ...
        app_label = "girjasoft_audit"


class GirjasoftAuditInfo(models.Model):
    """
    GirjasoftAuditInfo model to store additional info
    """
...
class GirjasoftAuditLog(HistoricalRecords):
    """
    Model to store additional information for historical records.
    """

    # def __init__(self, *args, bases=None, **kwargs):
    #     super(GirjasoftAuditLog, self).__init__(*args, **kwargs)
    #     self.is_girjasoft_audit_log = True
...
def pre_create_girjasoft_audit_log(sender, instance, *args, **kwargs):
    """
...
def post_create_girjasoft_audit_log(sender, instance, *_args, **kwargs):
    """
    ...
    try:
        ...
        if isinstance(history_instance, GirjasoftAuditLog):
