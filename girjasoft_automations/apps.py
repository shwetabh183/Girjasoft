"""
App configuration for the Girjasoft Automations app.
...
class GirjasoftAutomationConfig(AppConfig):
    """Configuration class for the Girjasoft Automations Django app."""

    default_auto_field = "django.db.models.BigAutoField"
    name = "girjasoft_automations"
    ...
    def ready(self) -> None:
        ...
        try:
            ...
            from base.templatetags.girjasoftfilters import app_installed
            from employee.models import Employee
            from girjasoft_automations.methods.methods import get_related_models
            from girjasoft_automations.models import MODEL_CHOICES
            ...
            try:
                from girjasoft_automations.signals import start_automation
