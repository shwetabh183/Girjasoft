    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.girjasoftmailtemplate')),
                ...
                ('template_attachments', models.ManyToManyField(blank=True, related_name='template_attachment', to='base.girjasoftmailtemplate')),
            ],
            options={
                'abstract': False,
            },
