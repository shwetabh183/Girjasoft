"""
girjasoft_automation/signals.py
...
from girjasoft.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    from girjasoft_automations.methods.methods import get_model_class, split_query_string
    ...
    @receiver(post_delete, sender=GirjasoftMailTemplate)
    @receiver(post_save, sender=GirjasoftMailTemplate)
...
def send_automated_mail(
    ...
    from girjasoft_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from girjasoft_automations.methods.methods import (
        get_model_class,
