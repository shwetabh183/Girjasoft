"""
girjasoft_automations/views/cbvs.py
"""
...
from girjasoft.decorators import login_required, permission_required
from girjasoft_automations import models
from girjasoft_automations.filters import AutomationFilter
from girjasoft_automations.forms import AutomationForm
from girjasoft_views.generic.cbv import views


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("girjasoft_automations.view_mailautomation"), name="dispatch"
)
class AutomationSectionView(views.GirjasoftSectionView):
    """
    ...
    template_name = "girjasoft_automations/section_view.html"
...
class AutomationNavView(views.GirjasoftNavView):
    """
    AutomationNavView
    """
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.actions = []
        if self.request.user.has_perm("girjasoft_automations.add_mailautomation"):
            self.create_attrs = f"""
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("girjasoft_automations.change_mailautomation"), name="dispatch"
)
class AutomationFormView(views.GirjasoftFormView):
    """
    AutomationFormView
    """
    ...
    template_name = "girjasoft_automations/automation_form.html"
...
class AutomationListView(views.GirjasoftListView):
    """
    AutomationListView
    """
...
class AutomationDetailedView(views.GirjasoftDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("girjasoft_automations.add_mailautomation"), name="dispatch"
)
class LoadAutomationsView(View):
    template_name = "girjasoft_automations/load_automation.html"
    ...
    def post(self, request):
        ...
        for template_json in templates_raw:
            if template_json["pk"] in required_template_pks:
                ...
                existing = GirjasoftMailTemplate.objects.filter(
        ...
        for automation_json in selected_automations:
            ...
            mail_template = GirjasoftMailTemplate.objects.filter(
                body=template_body
            ).first()
