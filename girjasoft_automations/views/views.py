"""
girjasoft_automation/views/views.py
"""
...
from girjasoft_automations.methods.methods import generate_choices
from girjasoft_automations.methods.serialize import serialize_form
from girjasoft_automations.models import MailAutomation
from girjasoft_automations.signals import REFRESH_METHODS
from girjasoft_views.generic.cbv.views import GirjasoftFormView
...
@login_required
@permission_required("girjasoft_automations.delete_mailautomation")
...
@login_required
@permission_required("girjasoft_automations.add_mailautomation")
