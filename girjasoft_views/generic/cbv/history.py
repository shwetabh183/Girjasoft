"""
girjasoft_views/generic/cbv/history.py
"""
...
from girjasoft_views.cbv_methods import hx_request_required
from girjasoft_views.generic.cbv.views import GirjasoftFormView
from girjasoft_views.history_methods import get_diff


@method_decorator(hx_request_required, name="dispatch")
class GirjasoftHistoryView(DetailView):
    """
    GenericGirjasoftProfileView
    """

    template_name = "generic/girjasoft_history_view.html"
