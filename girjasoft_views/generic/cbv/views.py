...
from girjasoft.filters import FilterSet
from girjasoft.group_by import group_by_queryset
from girjasoft.girjasoft_middlewares import _thread_locals
from girjasoft.signals import post_generic_import, pre_generic_import
from girjasoft_views import models
from girjasoft_views.cbv_methods import (  # update_initial_cache,
    assign_related,
    export_xlsx,
...
from girjasoft_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
...
class GirjasoftListView(ListView):
    """
    GirjasoftListView
    """
    ...
    template_name: str = "generic/girjasoft_list_table.html"
    ...
    def serve_import_sheet(self, request, *args, **kwargs):
        ...
        if not self.import_accessibility():
            ...
            return GirjasoftFormView.HttpResponse()
    ...
    def get_context_data(self, **kwargs: Any):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[GirjasoftListView] = context
        from girjasoft.urls import path, urlpatterns
    ...
    def export_data(self, *args, **kwargs):
        ...
        class GirjasoftListViewResorce(resources.ModelResource):
            """
        ...
        book_resource = GirjasoftListViewResorce()
...
class GirjasoftSectionView(TemplateView):
    """
    Girjasoft Template View
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, GirjasoftListView)
    ...
    template_name = "generic/girjasoft_section.html"
...
@method_decorator(hx_request_required, name="dispatch")
class GirjasoftDetailedView(DetailView):
    """
    HorillDetailedView
    """

    title = "Detailed View"
    template_name = "generic/girjasoft_detailed_view.html"
    header: dict = {
        "title": "Girjasoft",
        "subtitle": "Girjasoft Detailed View",
        "avatar": "",
    }
    body: list = []
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, GirjasoftDetailedView)
...
@method_decorator(hx_request_required, name="dispatch")
class GirjasoftTabView(TemplateView):
    """
    GirjasoftTabView
    """

    view_id: str = get_short_uuid(3, "htv")
    template_name = "generic/girjasoft_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.query_params = {}
        # update_initial_cache(request, CACHE, GirjasoftTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[GirjasoftTabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class GirjasoftCardView(ListView):
    """
    GirjasoftCardView
    """
    ...
    template_name = "generic/girjasoft_card.html"
    context_object_name = "queryset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, GirjasoftCardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[GirjasoftCardView] = context
        referrer = self.request.GET.get("referrer", "")
        if referrer:
            # Remove the protocol and domain part
            referrer = "/" + "/".join(referrer.split("/")[3:])
...
@method_decorator(hx_request_required, name="dispatch")
class GirjasoftFormView(FormView):
    """
    GirjasoftFormView
    """
    ...
    template_name = "generic/girjasoft_form.html"
    ids_key: str = "instance_ids"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # update_initial_cache(request, CACHE, GirjasoftFormView)
    ...
    def get_form(self, form_class=None):
        ...
        if not hasattr(self, "form"):
            ...
            # CACHE.get(self.request.session.session_key + "cbv")[GirjasoftFormView] = form
            self.form = form
        return self.form
...
@method_decorator(hx_request_required, name="dispatch")
class GirjasoftNavView(TemplateView):
    """
    GirjasoftNavView
    ...
    template_name = "generic/girjasoft_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, GirjasoftNavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[GirjasoftNavView] = context
        return context
...
@method_decorator(hx_request_required, name="dispatch")
class GirjasoftProfileView(DetailView):
    """
    GenericGirjasoftProfileView
    """

    template_name = "generic/girjasoft_profile_view.html"
    view_id: str = None
    filter_class: FilterSet = None
    push_url: str = None
    key_name: str = "pk"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.ordered_ids_key = f"ordered_ids_{self.model.__name__.lower()}"
        # update_initial_cache(request, CACHE, GirjasoftProfileView)
