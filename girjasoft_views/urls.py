"""
girjasoft_views/urls.py
"""

from django.urls import path

from girjasoft_views import views
from girjasoft_views.generic.cbv import history
from girjasoft_views.generic.cbv.views import ReloadMessages
...
urlpatterns = [
    ...
    path(
        "generic-delete",
        views.GirjasoftDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
    path(
        "girjasoft-history-revert/<int:pk>/<int:history_id>/",
        history.GirjasoftHistoryView.as_view(),
        name="history-revert",
    ),
]
