...
from girjasoft.signals import post_generic_delete, pre_generic_delete
from girjasoft_views import models
from girjasoft_views.cbv_methods import get_short_uuid, login_required, merge_dicts
from girjasoft_views.forms import SavedFilterForm
from girjasoft_views.generic.cbv.views import GirjasoftFormView, GirjasoftListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.GirjasoftModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(GirjasoftFormView):
    """
    SavedFilter
    """
...
class DynamiListView(GirjasoftListView):
    """
...
class GirjasoftDeleteConfirmationView(View):
    """
