...
This module is used to write girjasoft form select widgets
"""
...
class GirjasoftMultiSelectWidget(forms.Widget):
    """
    GirjasoftMultiSelectWidget
    """
    ...
    template_name = "girjasoft_widgets/girjasoft_multiselect_widget.html"
