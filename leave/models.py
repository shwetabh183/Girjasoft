...
class LeaveType(GirjasoftModel):
...
class CompanyLeave(GirjasoftModel):
...
class AvailableLeave(GirjasoftModel):
...
class LeaveRequest(GirjasoftModel):
    employee_id = models.ForeignKey(
...
class LeaverequestComment(GirjasoftModel):
    """
...
class LeaveAllocationRequest(GirjasoftModel):
    leave_type_id = models.ForeignKey(
        LeaveType, on_delete=models.PROTECT, verbose_name=_("Leave type")
    )
    employee_id = models.ForeignKey(
...
class LeaveallocationrequestComment(GirjasoftModel):
    """
...
class RestrictLeave(GirjasoftModel):
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaveRequest(GirjasoftModel):
        leave_type_id = models.ForeignKey(
...
class LeaveGeneralSetting(GirjasoftModel):
    """
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaverequestComment(GirjasoftModel):
        """
...
class EmployeePastLeaveRestrict(GirjasoftModel):
...
if apps.is_installed("attendance"):
    ...
    class OverrideLeaveRequests(LeaveRequest):
        ...
        #     """
        #     WorkRecords = get_girjasoft_model_class(
