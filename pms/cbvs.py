...
from girjasoft.decorators import login_required, owner_can_enter, permission_required
...
class BonusPointSettingSectionView(views.GirjasoftSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.GirjasoftNavView):
    """
...
class BonusPointSettingFormView(views.GirjasoftFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.GirjasoftListView):
    """
...
class EmployeeBonusPointSectionView(views.GirjasoftSectionView):
    """
...
class EmployeeBonusPointNavView(views.GirjasoftNavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.GirjasoftFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.GirjasoftListView):
    """
    BnusPoint list view
    """
...
@method_decorator(login_required, name="dispatch")
class FeedbackEmployeeFormView(views.GirjasoftFormView):
    """
...
class BulkFeedbackFormView(views.GirjasoftFormView):
    """
    Feedback other employee form View
    """
