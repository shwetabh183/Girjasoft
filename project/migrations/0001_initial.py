    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.FileField(blank=True, null=True, upload_to=girjasoft.models.upload_path, verbose_name='Project File')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateField(blank=True, null=True, verbose_name='End Date')),
                ('document', models.FileField(blank=True, null=True, upload_to=girjasoft.models.upload_path, verbose_name='Task File')),
                ('description', models.TextField(verbose_name='Description')),
